...
def help(update: Update, _: CallbackContext, meta_id) -> None:
  if chat_id not in ALLOWED_CHATS:
    help_text = (
      ...
      "19m19p19s1234z567z_0m (пример - кокуши с 13сторонним ожиданием и акадорой взятой со стены),\n"
      "для пробелов в руке используйте нижнее подчёркивание - `_`,\n"
      "для тайла рубашкой используйте заглавную латинскю i - `I`,\n"
